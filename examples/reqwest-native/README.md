...
```bash
cd examples/reqwest-native && \
    cargo build && \
    php -d extension=../../target/debug/libexample_reqwest_native.so test.php
```
...
See the [source code](https://github.com/danog/php-tokio/tree/master/examples/reqwest-native) of the example for more info on how it works!
